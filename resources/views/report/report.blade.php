<x-app-layout>
        ...
        <div class="w-[17%] bg-white p-4 border-r border-gray-300">
                ...
                <ul class="space-y-2" style="list-style: none; padding: 0;">
                        <li><a href="" class="flex items-center text-blue-500 text-nowrap hover:text-blue-900 sidebar-item"
                                style="font-size: 14px" data-url="{{ route('report.aos') }}"><span
                        ...
                        <li><a href=""
                                ...
                                style="font-size: 14px" data-url="{{ route('report.prtd.index') }}"><span
        ...
        <div class="flex-1 bg-blue-200" id="main-content">
                <h1 class="text-3xl text-center font-bold mb-4 p-6">Main Content Area</h1>
                <p class="text-center p-6">This is where the main content will go.</p>
        </div>
